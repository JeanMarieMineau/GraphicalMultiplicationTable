...
Depending on the selected table (for exemple x), a line is drawn between the a points and the a*x point.

The exemples change the number of points and the tables.
