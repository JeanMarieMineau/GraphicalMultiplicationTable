...
Depending on the selected table (for example x), a line is drawn between the 'a' points and the 'a*x' point.

The examples change the number of points and the tables.
